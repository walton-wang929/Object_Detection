# -*- coding: utf-8 -*-
"""
Created on Wed Feb  7 20:28:58 2018
...
class Atr_Gender():
    ...
    def predict(self,frame):
        ...
        softmax_tensor = self.classify_graph.get_operation_by_name('import/final_result')
 
        input_img = self.classify_graph.get_operation_by_name("import/DecodeJpeg")
 
        results = self.sess.run(softmax_tensor.outputs[0],{input_img.outputs[0]:frame})
...
Gender_Classify_MODEL = os.path.join(MODEL_DIR,"gender_inception")
Gender_Classify_CKPT = os.path.join(Gender_Classify_MODEL,'intermediate_45000.pb')
