...
MODEL_NAME = r'D:\TF_Try\tensorflow_models\research\oid\data'

PATH_TO_CKPT = MODEL_NAME + '/frozen_inference_graph.pb'

PATH_TO_LABELS = r'D:\TF_Try\tensorflow_models\research\oid\data\oid_bbox_trainable_label_map.pbtxt'
...
PATH_TO_TEST_IMAGES_DIR = r'D:\TF_Try\tensorflow_models\research\object_detection\My_Project\BodyPartition\test\img_'
#TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, 'img_{}.png'.format(i)) for i in range(41520, 41585) ]
            
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        
        for i in range(41520,41585):
        
            path = PATH_TO_TEST_IMAGES_DIR + str(i) + '.png'
            ...
            for box, score, cls in zip(boxes,scores,classes):
                ...
                cv2.putText(frame,'%s:%.3f'%(class_name,score*100),(x1,y1),1,0.5,(0,0,255),1,cv2.LINE_AA)
